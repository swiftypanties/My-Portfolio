  ...
  return (
    <>
      <div>
        ...
        <spline-viewer data-aos="fade-top" data-aos-duration="1500" className="purple-pipe" url="https://prod.spline.design/mE87wxrenYGC2Iix/scene.splinecode"></spline-viewer>
